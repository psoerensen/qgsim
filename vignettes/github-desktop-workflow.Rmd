...
This section is for collaborators who want to edit `qgsim` and contribute changes using standard Git commands.

If you only want to install and use `qgsim`, you do not need to clone the repository. Install it from the R Console instead:
...
After `cd qgsim`, you are in the local `qgsim` repository folder. This is the folder where you should run Git commands.

The local `qgsim` repository folder is the top-level folder that contains files and folders such as:
